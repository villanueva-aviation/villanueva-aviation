...
export const CONTENIDO_EXCLUSIVO: ContenidoExclusivo[] = [
  ...
  },
  {
    ...
    duracion: "3 secciones",
    imagen: "/images/exclusivo-checklist-da40.jpg",
  ...
  },
  {
    ...
    duracion: "3 secciones",
    imagen: "/images/exclusivo-checklist-c208.jpg",
    interactivoHref: "/premium/checklist/c208",
  },
  {
    id: "checklist-premium-dakota",
    tipo: "Checklist",
    titulo: "Checklist Premium — Piper PA-28-236 Dakota",
    descripcion: "Checklist completo, flujos de memoria y V-speeds del Piper PA-28-236 Dakota, tomados de su manual (POH).",
    duracion: "3 secciones",
    imagen: "/images/exclusivo-checklist-dakota.jpg",
    interactivoHref: "/premium/checklist/dakota",
  },
  {
    id: "checklist-premium-c185",
    tipo: "Checklist",
    titulo: "Checklist Premium — Cessna 185 Skywagon",
    descripcion: "Avión de tren convencional: checklist completo con los puntos de la rueda de cola, flujos de memoria y velocidades de su manual.",
    duracion: "3 secciones",
    imagen: "/images/exclusivo-checklist-c185.jpg",
