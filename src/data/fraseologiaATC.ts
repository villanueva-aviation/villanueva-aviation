...
export const FRASEOLOGIA_RODAJE_DESPEGUE: PhraseologyCard[] = [
  ...
  },
  {
    ...
    elementos: [
      ...
      { descripcion: "Dices tu identificación", palabrasClave: ["xb vla", "xb-vla", "x-ray bravo", "x ray bravo", "xray bravo", "ex rey bravo", "ex ray bravo", "torre eiffel", "extreme", "victor lima alfa", "lima alfa", "excre", "extremo", "excel", "exhebra", "extre"] },
    ],
  },
  {
