...
export const ACADEMIA_MODULOS: AcademiaModulo[] = [
  ...
  },
  {
    ...
    actividades: [
      ...
      { id: "interactividad-3", tipo: "interactividad", titulo: "Relaciona más términos clave", widget: "terminos", termSetId: "navegacion-2" },
      { id: "interactividad-4", tipo: "interactividad", titulo: "Simulador de decisión: corrección de deriva por viento", widget: "escenario" },
