...
export const RECURSOS_DESCARGAS: RecursoDescarga[] = [
  ...
  },
  {
    id: "checklist-dakota",
    categoria: "Checklists",
    nombre: "Checklist Piper PA-28-236 Dakota — Normal y emergencia",
    descripcion: "Cuatro plazas de hélice de velocidad constante: checklist con selector de combustible por tanque, hielo de carburador y emergencias, con datos de su manual.",
    version: "v1.0",
    fecha: "2026-09-26",
    imagen: "/images/exclusivo-checklist-dakota.jpg",
    interactivoHref: "/checklist/dakota",
    soloInteractivo: true,
  },
  {
    id: "checklist-c185",
    categoria: "Checklists",
    nombre: "Checklist Cessna 185 Skywagon — Normal y emergencia",
    descripcion: "Avión de tren convencional: checklist con la rueda de cola, cowl flaps y emergencias, con datos de su manual.",
    version: "v1.0",
    fecha: "2026-09-26",
    imagen: "/images/exclusivo-checklist-c185.jpg",
    interactivoHref: "/checklist/c185",
    soloInteractivo: true,
  },
  {
