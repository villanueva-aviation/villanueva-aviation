      ...
      <Container className="py-16 md:py-24">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {CONTENIDO_EXCLUSIVO.map((item, i) => (
            <Reveal key={item.id} delay={i * 100} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03]">
              ...
              <div className="p-5">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white/60">{item.descripcion}</p>
