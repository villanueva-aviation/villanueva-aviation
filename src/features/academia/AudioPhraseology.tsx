...
const DEFAULT_CARDS: PhraseologyCard[] = [
  {
    ...
    elementos: [
      { descripcion: "A quién llamas (Torre)", palabrasClave: ["torre"] },
      {
        ...
        palabrasClave: ["xb vla", "xb-vla", "equis be uve ele a", "x-ray bravo", "x ray bravo", "xray bravo", "ex rey bravo", "ex ray bravo"],
      },
  ...
  },
  {
    ...
    elementos: [
      ...
      { descripcion: "Tu identificación", palabrasClave: ["xb vla", "xb-vla", "x-ray bravo", "x ray bravo", "xray bravo", "ex rey bravo", "ex ray bravo"] },
  ...
  },
  {
    ...
    elementos: [
      ...
      { descripcion: "Terminas con tu identificación", palabrasClave: ["xb vla", "xb-vla", "x-ray bravo", "x ray bravo", "xray bravo", "ex rey bravo", "ex ray bravo"] },
    ],
  },
];
