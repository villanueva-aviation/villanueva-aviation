...
const DEFAULT_CARDS: PhraseologyCard[] = [
  {
    ...
    elementos: [
      { descripcion: "A quién llamas (Torre)", palabrasClave: ["torre"] },
      {
        ...
        palabrasClave: ["xb vla", "xb-vla", "equis be uve ele a", "x-ray bravo", "x ray bravo", "xray bravo", "ex rey bravo", "ex ray bravo", "torre eiffel", "extreme", "victor lima alfa", "lima alfa"],
      },
  ...
  },
  {
    ...
    elementos: [
      ...
      { descripcion: "Tu identificación", palabrasClave: ["xb vla", "xb-vla", "x-ray bravo", "x ray bravo", "xray bravo", "ex rey bravo", "ex ray bravo", "torre eiffel", "extreme", "victor lima alfa", "lima alfa"] },
